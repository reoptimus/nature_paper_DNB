...
No government/financial sector vulnerability calculation
...
activation_gov_vuln = 0  # No alternative gov vulnerability calculation
activation_fin_vuln = 0  # No alternative financial vulnerability calculation
